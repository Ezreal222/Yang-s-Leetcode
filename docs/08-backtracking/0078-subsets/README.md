...
- [0090. Subsets II](../0090-subsets-ii/README.md) — nums 有重复, 加同层去重 (套 0040 思路)
- [0491. Non-decreasing Subsequences](../0491-non-decreasing-subsequences/README.md) — 类似子集, 但不能 sort → 用 unordered_set 同层去重
